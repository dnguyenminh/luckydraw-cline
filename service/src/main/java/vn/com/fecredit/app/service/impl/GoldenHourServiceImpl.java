...
public class GoldenHourServiceImpl implements GoldenHourService {
    ...
    public List<GoldenHourDTO.Response> getAllByEventId(Long eventId) {
        List<GoldenHour> goldenHours = goldenHourRepository.findAllByEventIdAndStatus(eventId, AbstractStatusAwareEntity.STATUS_ACTIVE);
    ...
    public GoldenHourDTO.Response getCurrentGoldenHour(Long eventId) {
        ...
        Optional<GoldenHour> currentGoldenHour = goldenHourRepository.findAllByEventIdAndStatus(eventId, AbstractStatusAwareEntity.STATUS_ACTIVE)
            .stream()
