...
@NoArgsConstructor
@AllArgsConstructor
public class UpdateGoldenHourRequest {
    ...
    /**
     * Creates a Patch object containing only the modified fields
     */
    public UpdateGoldenHourRequest.Patch toPatch() {
        return new UpdateGoldenHourRequest.Patch(this);
    }
    ...
    public static class Patch {
        ...
        private Patch(UpdateGoldenHourRequest request) {
            this.startTime = request.getStartTime();
            this.endTime = request.getEndTime();
            this.probabilityMultiplier = request.getProbabilityMultiplier();
            this.recurringDays = request.getRecurringDays();
        ...
        public boolean hasProbabilityMultiplier() {
            return probabilityMultiplier != null;
        }

        public boolean hasRecurringDays() {
            return recurringDays != null;
        }
