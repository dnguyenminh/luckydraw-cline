...
public interface SpinHistoryService {
     ...
     * Record spin history
     */
    SpinHistoryDTO recordSpin(Long eventId, Long participantId, Long rewardId);

    /**
     * Get spin history by ID
     */
    SpinHistoryDTO getSpinHistoryById(Long id);
     ...
     */
    List<SpinHistoryDTO> getAllSpinHistory();

    /**
     * Get paginated spin history
     */
    Page<SpinHistoryDTO> getSpinHistory(PageRequest pageRequest);

    /**
     * Search spin history
     */
    Page<SpinHistoryDTO> searchSpinHistory(SearchRequest searchRequest);

    /**
     * Get spin history by event
     */
    List<SpinHistoryDTO> getSpinHistoryByEvent(Long eventId);

    /**
     * Get spin history by participant
     */
    List<SpinHistoryDTO> getSpinHistoryByParticipant(Long participantId);

    /**
     * Get spin history by reward
     */
    List<SpinHistoryDTO> getSpinHistoryByReward(Long rewardId);

    /**
     * Get spin history by date range
     */
    List<SpinHistoryDTO> getSpinHistoryByDateRange(LocalDateTime startDate, LocalDateTime endDate);

    /**
     * Get participant's last spin
     */
    SpinHistoryDTO getLastSpin(Long participantId);

    /**
     * Get participant's last winning spin
     */
    SpinHistoryDTO getLastWinningSpin(Long participantId);
